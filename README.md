...
## Step 7: Prepare MQTT Packet script

### create sh file paste in the script and change these values of MQTT packet constructor accordingly to your configuration:
